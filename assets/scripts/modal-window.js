let modal = $modal({
    ...
    <p class="brand__text">Vitasystem — безалкогольный негазированный низкокалорийный напиток, обогащенный
      ...
      глюкозу и способствуют общей здоровой среде желудочно-кишечного тракта. </p>
      <p class="brand__text">А для тех,
      кто предпочитает следить не только за здоровьем, но и за своей фигурой, отлично подойдет
      <span class="green font-bold">Vitasystem Detox</span> с пониженным содержанием сахара.</p>
